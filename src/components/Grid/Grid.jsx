...
function Grid() {
    ...
    useGSAP(() => {
        ...
        const splitHeading = SplitText.create('.grid-heading', {
            type: 'chars',
            charsClass: 'grid-heading-char'
        });

        const splitSubheading = SplitText.create('.grid-subheading', {
            type: 'words',
        });
        ...
        // Subheading
        gsap.from(splitSubheading.words, {
            opacity: 0,
            y: 20,
            stagger: 0.05,
            ease: "power2.out",
    ...
    return (
        <section ref={containerRef} className='p-4 py-20 flex flex-col gap-2 2xl:w-3/4 2xl:mx-auto'>
            ...
            <h2 className='grid-heading font-lexend text-6xl md:text-7xl xl:text-8xl font-semibold tracking-tighter text-amber-950'>Ctrl + Me</h2>
            <p className='grid-subheading tracking-tighter -mt-1 font-lexend text-right xl:text-xl font-medium text-sm sm:text-base text-amber-700/50'>The guy behind the keyboard</p>
            <main className='grid-container grid grid-cols-1 gap-8 my-6 md:grid-cols-2 '>

                <article className='grid-card bg-gradient-to-br from-amber-800 to-amber-400 via-amber-700   shadow-lg p-4  rounded-xl relative xl:pt-6 xl:p-8  '>
                ...
                <article className='grid-card bg-gradient-to-br from-amber-50 to-amber-500 via-amber-100   shadow-lg p-4  rounded-xl relative xl:pt-6 xl:p-8'>
                ...
                <article className='grid-card bg-gradient-to-br from-amber-800 to-amber-400 via-amber-700   shadow-lg p-4  rounded-xl relative md:col-span-2 xl:pt-6 xl:p-8'>
