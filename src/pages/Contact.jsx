...
const Contact = () => {
    ...
    return (
        <section className="p-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col justify-center gap-4 mt-8">
                <fieldset>
                    <label className="font-lexend" htmlFor="name">Enter your name</label>
                    <input
                        id="name"
                        type="text"
                        name="name"
                        ...
                        className="px-2 py-2 w-full mt-1 rounded-xl text-amber-900 placeholder:text-amber-800/30 shadow-md"
                    />
                </fieldset>

                <fieldset>
                    <label className="font-lexend" htmlFor="phone_number">Enter your email</label>
                    <input
                        id="email"
                        type="text"
                        name="email"
                ...
                <fieldset>
                    <label className="font-lexend" htmlFor="message">Enter your message</label>
                    <textarea
                        id="message"
                        type="text"
                        name="message"
                ...
                <button
                    type="submit"
                    className="border-2 py-2 rounded-full border-amber-900 text-amber-700">
                    Send my message
                </button>
            </form>
        </section>
